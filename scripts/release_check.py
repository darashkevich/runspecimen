...
def check_versions() -> None:
    ...
    if "PreToolUse" not in (hooks.get("hooks") or {}) or "BeforeTool" not in (hooks.get("hooks") or {}):
        raise SystemExit("plugin hooks.json must declare PreToolUse and BeforeTool gates")
    plugin_xml = (

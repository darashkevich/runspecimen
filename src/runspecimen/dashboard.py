...
<link rel="icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='6' fill='%23070A0F'/%3E%3Crect x='10' y='8.5' width='12' height='19' rx='6' fill='%230d1219' stroke='%239be56a' stroke-width='1.75'/%3E%3Cpath d='M13.25 14.25V7.1c0-3.15 5.5-3.15 5.5 0v7.15' stroke='%236ec8ff' stroke-width='1.75' stroke-linecap='round' fill='none'/%3E%3Crect x='11.85' y='12.15' width='8.3' height='4.1' rx='1.05' fill='%23111821' stroke='%236ec8ff' stroke-width='1.35'/%3E%3Cpath d='M13.35 20.7 15.2 22.65 19.15 17.7' stroke='%239be56a' stroke-width='1.75' stroke-linecap='round' stroke-linejoin='round' fill='none'/%3E%3C/svg%3E" type="image/svg+xml">
<style>
...
.topbar{{height:56px;background:#0f1a2c;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:0 max(20px,calc((100vw - 1120px)/2))}}.brand{{display:flex;align-items:center;gap:10px;font-weight:700;letter-spacing:.02em}}.brand-mark{{width:28px;height:28px;border-radius:6px;display:grid;place-items:center;background:#070A0F;overflow:hidden}}.brand-mark svg{{width:22px;height:22px;display:block}}.topbar-meta{{display:flex;align-items:center;gap:12px}}.docs-nav{{display:flex;gap:12px;font-size:12px}}.docs-nav a{{color:#c5cedc;text-decoration:none}}.docs-nav a:hover{{color:#fff;text-decoration:underline}}.read-only{{font-size:11px;color:#c5cedc;border:1px solid #3d4a61;border-radius:4px;padding:3px 8px}}
...
<body>
<header class="topbar"><div class="brand"><span class="brand-mark" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none"><rect x="10" y="8.5" width="12" height="19" rx="6" fill="#0d1219" stroke="#9be56a" stroke-width="1.75"/><path d="M13.25 14.25V7.1c0-3.15 5.5-3.15 5.5 0v7.15" stroke="#6ec8ff" stroke-width="1.75" stroke-linecap="round"/><rect x="11.85" y="12.15" width="8.3" height="4.1" rx="1.05" fill="#111821" stroke="#6ec8ff" stroke-width="1.35"/><path d="M13.35 20.7 15.2 22.65 19.15 17.7" stroke="#9be56a" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/></svg></span><span>RunSpecimen</span></div><div class="topbar-meta"><nav class="docs-nav" aria-label="Documentation"><a href="#about">About</a><a href="{_escape(DOCS_URLS['user_guide'])}" target="_blank" rel="noopener noreferrer">User guide</a><a href="{_escape(DOCS_URLS['faq'])}" target="_blank" rel="noopener noreferrer">FAQ</a></nav><span class="read-only">Local · loopback only · read-only</span></div></header>
<main>
